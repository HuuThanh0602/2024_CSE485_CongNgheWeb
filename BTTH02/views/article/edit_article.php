    ...
    <main class="container mt-5 mb-5">
        ...
        <div class="row">
            <div class="col-sm">
                ...
                <form action="./index.php?controller=Article&action=editArticle&id=<?php echo $id ?>" method="post">
                    <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="lblTitleName">Tên tiêu đề </span>
                        <input type="text" class="form-control" name="txtTitleName" value="<?php echo $articlesbyId['tieude']?>" >
                    </div>
                    <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="lblArticleName">Tên bài hát </span>
                        <input type="text" class="form-control" name="txtArticleName" value="<?php echo $articlesbyId['tenbhat']?>" >
                    </div>

                    <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="lblSummaryName"> Tóm tắt </span>
                        <input type="text" class="form-control" name="txtSummaryName" value="<?php echo $articlesbyId['tomtat']?>">
                    </div>

                    <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="lblSummaryName"> Nội dung </span>
                        <input type="text" class="form-control" name="txtContentName" value="<?php echo $articlesbyId['noidung']?>" >
                    </div>
                    <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="lblImage">Hình ảnh</span>
                        <input type="text" class="form-control" name="txtImage_id" value="<?php echo $articlesbyId['hinhthanh']?>">
                    </div>
                    <div class="input-group mt-3 mb-3">
