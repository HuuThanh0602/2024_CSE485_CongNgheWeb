        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary shadow p-3 bg-white rounded">
            <div class="container-fluid">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../../views/category/list_category.php">Thể loại</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active fw-bold" href="../../views/author/index_author.php">Tác giả</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="row">
            <div class="col-sm">
                ...
                <div class="input-group mt-3 mb-3">
                        ...
                        <input type="text" class="form-control" name="id" readonly value="<?php echo $author_id ?>">
                    </div>

                    <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="lblCatName">Tên tác giả</span>
                        <input type="text" class="form-control" name="ten_tgia" value = "<?php  echo $author_name ?>">
                    </div>
