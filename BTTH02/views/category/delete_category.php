...
<body>
    ...
    <?php $category_id = intval($_GET['id']);
            ...
            <div class="col-sm">
                ...
                <div class="input-group mt-3 mb-3">
                    ...
                    <div class="input-group mt-3 mb-3">
                        ...
                        <input type="text" class="form-control" name="txtCatName" readonly value = "<?php  echo $category_name; ?>">
                    </div>

                    <div class="form-group  float-end ">
                    <a href="../../index.php?controller=category&action=delete&id=<?php echo $category_id; ?>" class="btn btn-danger">Xoá</a>
